  ...
  return (
    <>
      <article
        ...
        className={`rounded-md border hairline bg-surface p-4 pl-[14px] shadow-card relative group cursor-pointer hover:bg-surface-2/40 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent transition-colors ${
          done ? 'opacity-60' : ''
        }`}
        style={
